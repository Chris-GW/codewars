...
public class MazeSolverTest {
    ...
    public void mazeCell_0_nonBorder() {
        ...
        for (Direction direction : Direction.values()) {
            assertFalse(mazeCell.hasBorderTo(direction), "should have no border in direction " + direction);
        }
    }
        ...
        for (Entry<Direction, Integer> directionToBorderCodeEntry : directionToBorderCode.entrySet()) {
            ...
            for (Direction direction : Direction.values()) {
                if (direction.equals(directionWithBorder)) {
                    assertTrue(mazeCell.hasBorderTo(direction), "should have border in direction " + direction);
                } else {
                    assertFalse(mazeCell.hasBorderTo(direction), "should have no border in direction " + direction);
                }
            }
